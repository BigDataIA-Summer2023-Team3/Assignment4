...
@st.cache_data
def generate_query_result(year, quarter, limit_value):
    # Format query with selected parameter values
    query = query_template.format(year=year, quarter=quarter, limit_value=limit_value)
...
if st.button("Generate Query Result"):
    ...
    with st.spinner("Executing query..."):
        results = generate_query_result(year, quarter, limit_value)
